...
<!-- Js Plugins -->
<script src="<?= base_url('jquery-3.5.1.min.js') ?>">
</script>
<script>
window.jQuery || document.write(
    '<script src=<?= base_url('bootstrap-4.0.0/assets/js/vendor/jquery-slim.min.js') ?>"><\/script>')
</script>
...
<script src="<?= base_url('colorlib-regform-7/vendor/jquery/jquery.min.js') ?>"></script>
<script src="<?= base_url('colorlib-regform-7/js/main.js') ?>"></script>
