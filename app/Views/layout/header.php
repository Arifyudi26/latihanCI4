...
<head>
    ...
    <title>Arif yudi Suryo Utomo</title>
    <link rel="canonical" href="https://getbootstrap.com/docs/4.0/examples/starter-template/">
    <link href="<?= base_url('bootstrap-4.0.0/dist/css/bootstrap.min.css') ?>" rel="stylesheet">
    <link rel="stylesheet"
        href="<?= base_url('colorlib-regform-7/fonts/material-icon/css/material-design-iconic-font.min.css') ?>">
    <!-- <link rel="stylesheet" href="<?= base_url('colorlib-regform-7/css/style.css') ?>"> -->
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                <a href="<?= base_url('auth/logout') ?>"><i class="fa fa-user"></i>Log out</a>
                            </div>
                        </div>
                    </div>
                </div>
