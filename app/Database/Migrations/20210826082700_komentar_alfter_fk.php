...
class KomentarAlfterFk extends \CodeIgniter\Database\Migration
{
    ...
    public function up()
    {
        ...
        $this->forge->addColumn('komentar', [
            'CONSTRAINT komentar_id_barang_foreign FOREIGN KEY(id_user) REFERENCES barang(id) ON DELETE NO ACTION ON UPDATE CASCADE',
        ]);
    }
    public function down()
    {
        ...
        $this->forge->addColumn('komentar', [
            'CONSTRAINT komentar_id_barang_foreign FOREIGN KEY(id_barang) REFERENCES user(id',
        ]);
    }
}